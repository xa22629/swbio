...
Requirements of a README.txt file:
- introduces the purpose of the code
- provides links to the data required to run it
- gives a clear command line example to show how to make it work (not sure about this one?)
- double check the notes I made in Jupyter Notebook to infer the formatting of a README.txt file
